...
O ApT é disponibilizado sob **modelo de licenciamento de software**, com diferentes modalidades de uso. O Autor concede ao licenciado o direito de utilizar a aplicação localmente — não há prestação de serviço, processamento remoto ou vínculo de fornecimento contínuo.
...
👉 Experimente o fluxo completo antes de adquirir uma licença.
...
👉 Ideal para advogados, peritos, delegados e profissionais autônomos que produzem laudos regularmente.

---

## 📩 Outros casos (equipes e instituições)

Caso necessite de licenciamento para equipe ou organização, entre em contato para verificar possibilidades de adaptação:
